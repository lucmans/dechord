...
% Real-time too slow claim
% Why Fourier and not other transforms
% More specific about contributions and goals
\section*{Abstract}
...
% Simple -> specific
% Might not outperform -> positiever verwoorden (kan gewoon gebruikt worden)
% Ipv speculatief (kan alles of niks/misschien), gewoon aangeven wat het wel of niet kan
